...
contract STYK_I is SafeMath,DateTime,PriceConsumerV3(0x9326BFA02ADD2366b30bacB125260Af641031331){
    
    
    
    constructor(uint256 _lockTime,uint256 _auctionExpiryTime,uint256 _auctionLimit)public{
   ...
   /*================================
        ...
        public
    {
        ...
        userEthDeposit[_customerAddress] = safeAdd(userEthDeposit[_customerAddress],tokensToEthereum_(_tokens));
        // fire event
        ...
        public
    {
        ...
        if(_calculateInfaltionHours() > 72)inflationTime = 0;
         userEthDeposit[_customerAddress] = safeSub(userEthDeposit[_customerAddress],tokensToEthereum_(_tokens));
        // fire event
    ...
    ==========================================*/
        ...
        function _calculateMonthlyRewards(address _to)internal view  returns(uint256){
       ...
       //To get amount of ethers deposited by user
        ...
        function getUserAffiliateBalance(address _user)external view returns(uint256){
        ...
        returns(uint256)
    {
       ...
       if(!userExists[_referredBy][_customerAddress] && _referredBy != address(0) && _referredBy != _customerAddress){
        ...
        userEthDeposit[_customerAddress] = safeAdd(userEthDeposit[_customerAddress],msg.value);
